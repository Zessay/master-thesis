...
from benchmark.seq2seqmem.main import main
from utils import Storage


def run(*argv):
	parser = argparse.ArgumentParser(description='A seq2seq mem model')
	args = Storage()

	parser.add_argument('--name', type=str, default='seq2seqmem',
	...
	parser.add_argument('--dataset', type=str, default='MyMemSeq2Seq',
	...
	parser.add_argument('--max_know_length', type=int, default=100,
		help="The max length of knowledge triplet.")
	...
	parser.add_argument('--log_dir', type=str, default="./tensorboard/music",
		help='Log directory for tensorboard. Default: ./tensorboard')
	parser.add_argument('--model_dir', type=str, default="./model/music",
		help='Checkpoints directory for model. Default: ./model')
	parser.add_argument('--cache_dir', type=str, default="./cache/music",
	...
	parser.add_argument('--lamb', type=float, default=1.0,
		help="The factor of the knowledge loss.")
